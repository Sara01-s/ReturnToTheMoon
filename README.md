...
**Storyline (Resumen de la historia sin incluir final, enganche)**
...
|----------------------|--------------|-----------|---------|-------------------------------|--------------|
| Boost QTE            |             |           |         | [Rapidez] = [Rápido] durante [BOOST_DURATION] segundos                         | [Rapidez] = [Muy Rápido] durante [BIG_BOOST_DURATION] segundos |
